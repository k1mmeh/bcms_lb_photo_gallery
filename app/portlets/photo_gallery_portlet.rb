class PhotoGalleryPortlet < Portlet
  ...
  def render
    ...
    @photos = ThumbnailedImage.by_section(@section).paginate(:per_page => per_page, :page => page, :order => 'file_blocks.published_date DESC NULLS FIRST, file_blocks.created_at DESC')
  end
